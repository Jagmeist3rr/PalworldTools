...
class PalsManager: ObservableObject{
    ...
    init(palsManager: [Pals]) {
        ...
        self.palsManager = [
            ...
            Pals(name: "Jolthog Cryst", icon: Image("Jolthog_Cryst"), title: "Watch Your Feet!", number: "#012B", element: ["Ice"], drops: ["Ice Organ"], food: 2, foodimage: foodImages, partnerSkill: "Cold Bomb", partnerSkillDescription: "When activated, equips Jolthog Cryst to the player's hand. When thrown at an enemy, causes an icy explosion upon impact.", worksuitabilty: ["Cooling":1]),
            ...
            Pals(name: "Mau Cryst", icon: Image("Mau_Cryst"), title: "Serene Glimmer", number: "#024B", element: ["Ice"], drops: ["Ice Organ","Sapphire"], food: 1, foodimage: foodImages, partnerSkill: "Gold Digger", partnerSkillDescription: "Sometimes digs up Gold Coin when assigned to Ranch.", worksuitabilty: ["Cooling":1,"Farming":1]),
            ...
            Pals(name: "Gobfin Ignis", icon: Image("Gobfin_Ignis"), title: "Volcano Thug", number: "#031B", element: ["Fire"], drops: ["Flame Organ"], food: 3, foodimage: foodImages, partnerSkill: "Angry Shark", partnerSkillDescription: "When activated, attacks targeted enemy with a powerful Spirit Fire. While in team, increases player's attack power.", worksuitabilty: ["Kindling":2,"Handiwork":1,"Transporting":1]),
            ...
            Pals(name: "Hangyu Cryst", icon: Image("Hangyu_Cryst"), title: "Glacial Harbinger", number: "#032B", element: ["Ice"], drops: ["Fiber","Ice Organ"], food: 2, foodimage: foodImages, partnerSkill: "Winter Trapeze", partnerSkillDescription: "While in team, can be summoned and used instead of a glider. Carries the player up high while gliding.", worksuitabilty: ["Handiwork":1,"Gathering":1,"Cooling":1,"Transporting":2]),
            ...
            Pals(name: "Mossanda Lux", icon: Image("Mossanda_Lux"), title: "Inheritor of the Storm", number: "#033B", element: ["Electric"], drops: ["Mushroom","Electric Organ","Leather"], food: 5, foodimage: foodImages, partnerSkill: "Plane Partner", partnerSkillDescription: "Can be ridden. Can rapidly fire a grenade launcher while mounted.", worksuitabilty: ["Generate Electricity":2,"Handiwork":2,"Lumbering":2,"Transporting":3]),
            ...
            Pals(name: "Eikthyrdeer Terra", icon: Image("Eikthyrdeer_Terra"), title: "Antlers of Gold", number: "#037B", element: ["Ground"], drops: ["Eikthyrdeer Venison","Leather","Horn"], food: 5, foodimage: foodImages, partnerSkill: "Guardian of the Golden Forest", partnerSkillDescription: "Can be ridden. Can perform a double jump while mounted. Increases efficiency of cutting trees.", worksuitabilty: ["Lumbering":2]),
            ...
            Pals(name: "Incineram Noct", icon: Image("Incineram_Noct"), title: "Hyena of the Darkest Night", number: "#040B", element: ["Dark"], drops: ["Horn","Leather"], food: 4, foodimage: foodImages, partnerSkill: "Darkclaw Hunter", partnerSkillDescription: "When activated, attacks targeted enemy with a powerful Hellfire Claw.", worksuitabilty: ["Handiwork":2,"Mining":1,"Transporting":2]),
            ...
            Pals(name: "Leezpunk Ignis", icon: Image("Leezpunk_Ignis"), title: "Self-proclaimed Fashionista", number: "#045B", element: ["Fire"], drops: ["Flame Organ","Silver Key"], food: 3, foodimage: foodImages, partnerSkill: "Sixth Sense", partnerSkillDescription: "When activated, utilizes its sixth sense to detect nearby dungeons.", worksuitabilty: ["Kindling":1,"Handiwork":1,"Gathering":1,"Transporting":1]),
            ...
            Pals(name: "Robinquill Terra", icon: Image("Robinquill_Terra"), title: "Archer of the Sands", number: "#048B", element: ["Grass","Ground"], drops: ["Wheat Seeds Arrow"], food: 3, foodimage: foodImages, partnerSkill: "Hawk Eye", partnerSkillDescription: "While fighting together, allows you to deal more damage to weak points.", worksuitabilty: ["Handiwork":2,"Gathering":2,"Lumbering":1,"Medicine Production":1,"Transporting":2]),
            ...
            Pals(name: "Foxcicle", icon: Image("Foxcicle"), title: "Claws of Ice", number: "#057", element: ["Ice"], drops: ["Leather","Ice Organ"], food: 3, foodimage: foodImages, partnerSkill: "Aurorau Guide", partnerSkillDescription: "While in a team, increases attack power of Ice pals.", worksuitabilty: ["Cooling":2]),
            ...
            Pals(name: "Pyrin Noct", icon: Image("Pyrin_Noct"), title: "Steed of Darkness", number: "#058B", element: ["Fire","Dark"], drops: ["Flame Organ","Leather"], food: 5, foodimage: foodImages, partnerSkill: "Black Hare", partnerSkillDescription: "Can be ridden. Applies Dark damage to the player's attacks while mounted.", worksuitabilty: ["Kindling":2,"Lumbering":1]),
            ...
            Pals(name: "Dinossom Lux", icon: Image("Dinosoom Lux"), title: "Guardian of Lightning", number: "#064B", element: ["Electric","Dragon"], drops: ["Tomato Seeds"], food: 6, foodimage: foodImages, partnerSkill: "Thunder Dragon", partnerSkillDescription: "Can be ridden. Enhances Electric attacks while mounted.", worksuitabilty: ["Generate Electricity":2,"Lumbering":2]),
            ...
            Pals(name: "Surfent Terra", icon: Image("Surfent_Terra"), title: "The Desert's Wrath", number: "#065B", element: ["Ground"], drops: ["Pal Fluids"], food: 5, foodimage: foodImages, partnerSkill: "Sand Swimmer", partnerSkillDescription: "Can be ridden.", worksuitabilty: ["Gathering":1]),
            ...
            Pals(name: "Vanwyrm Cryst", icon: Image("Vanwyrm_Cryst"), title: "Marauder of Frozen Skies", number: "#071B", element: ["Ice","Dark"], drops: ["Bone","Ice Organ","Sapphire"], food: 6, foodimage: foodImages, partnerSkill: "Aerial Marauder", partnerSkillDescription: "Can be ridden as a flying mount. Increases damage player deals to enemy weak points while mounted.", worksuitabilty: ["Cooling":2,"Transporting":2]),
            ...
            Pals(name: "Elphidran Aqua", icon: Image("Elphidran Aqua"), title: "Beast of the Tides", number: "#080B", element: ["Dragon","Water"], drops: ["High Quality Pal Oil"], food: 6, foodimage: foodImages, partnerSkill: "Amicable Water Dragon", partnerSkillDescription: "Can be ridden as a flying mount. While fighting together, Fire Pals drop more items when defeated.", worksuitabilty: ["Watering":3,"Lumbering":2]),
            ...
            Pals(name: "Kelpsea Ignis", icon: Image("Kelpsea_Ignis"), title: "Child of Molter Depths", number: "#081B", element: ["Fire"], drops: ["Raw Kelpsea"], food: 1, foodimage: foodImages, partnerSkill: "Lava Spout", partnerSkillDescription: "While in team, increases attack power of Fire Pals.", worksuitabilty: ["Kindling":1]),
            ...
            Pals(name: "Cryolinx", icon: Image("Cryolinx"), title: "Predator of Snow", number: "#083", element: ["Ice"], drops: ["Ice Organ"], food: 7, foodimage: foodImages, partnerSkill: "Dragon Hunter", partnerSkillDescription: "While fighting together, Dragon Pals drop more items when defeated.", worksuitabilty: ["Handiwork":1,"Lumbering":2,"Cooling":3]),
            ...
            Pals(name: "Blazehowl Noct", icon: Image("Blazehowl_Noct"), title: "Inferno Goliath", number: "#084B", element: ["Fire","Dark"], drops: ["Flame Organ"], food: 7, foodimage: foodImages, partnerSkill: "Darkflame Lion", partnerSkillDescription: "Can be ridden. While fighting together, Neutral Pals drop more items when defeated.", worksuitabilty: ["Kindling":3,"Lumbering:":2]),
            ...
            Pals(name: "Relaxaurus Lux", icon: Image("Relaxaurus_Lux"), title: "Gluutonous Thunder Dragon", number: "#085B", element: ["Dragon","Electric"], drops: ["High Quality Pal Oil","Electric Organ","Sapphire"], food: 7, foodimage: foodImages, partnerSkill: "Missile Party", partnerSkillDescription: "Can be ridden. Can rapidly fire a missile launcher while mounted.", worksuitabilty: ["Generating Electricity":3,"Transporting":1]),
            ...
            Pals(name: "Broncherry Aqua", icon: Image("Broncherry_Aqua"), title: "Waves of Summer", number: "#086B", element: ["Grass","Water"], drops: ["Broncherry Meat","Lettuce Seeds"], food: 7, foodimage: foodImages, partnerSkill: "Overaffectionate", partnerSkillDescription: "Can be ridden. While in team, Broncherry helps carry supplies, increasing the player's max carrying capacity.", worksuitabilty: ["Watering":3]),
            ...
            Pals(name: "Reptyro Cryst", icon: Image("Reptyro_Cryst"), title: "Ice-breaking Juggernaut", number: "#088B", element: ["Ice","Ground"], drops: ["Ice Organ"], food: 5, foodimage: foodImages, partnerSkill: "Ice-loving Beast", partnerSkillDescription: "Can be ridden. Improves efficiency of mining ores while mounted.", worksuitabilty: ["Mining":3,"Cooling":3]),
            ...
            Pals(name: "Kingpaca Cryst", icon: Image("Kingpaca_Cryst"), title: "Azure Fluff Commander", number: "#089B", element: ["Ice"], drops: ["Wool","Ice Organ"], food: 7, foodimage: foodImages, partnerSkill: "King of Muscles", partnerSkillDescription: "Can be ridden. While in team, Kingpaca helps carry supplies, increasing the player's max carrying capacity.", worksuitabilty: ["Gathering":1,"Cooling":3]),
            ...
            Pals(name: "Mammorest Cryst", icon: Image("Mammorest_Cryst"), title: "Frozen King", number: "#090B", element: ["Ice"], drops: ["High Quality Pal Oil","Leather","Mammorest Meat"], food: 8, foodimage: foodImages, partnerSkill: "Ice Crusher", partnerSkillDescription: "Can be ridden. Improves efficiency of cutting trees and mining ores while mounted.", worksuitabilty: ["Lumbering":2,"Mining":2,"Cooling":2]),
            ...
            Pals(name: "Wumpo Botan", icon: Image("Wumpo_Botan"), title: "Guardian of the Grassy Fields", number: "#091B", element: ["Grass"], drops: ["Lettuce Seeds","Tomato Seeds","Beautiful Flower"], food: 8, foodimage: foodImages, partnerSkill: "Guardian of the Grassy Fields", partnerSkillDescription: "Can be ridden. While in team, Wumpo Botan helps carry supplies, increasing the player's max carrying capacity.", worksuitabilty: ["Planting":1,"Handiwork":2,"Lumbering":3,"Transporting":4]),
            ...
            Pals(name: "Jormuntide Ignis", icon: Image("Jormuntide_Ignis"), title: "Volcanic Emperor", number: "#101B", element: ["Fire","Dragon"], drops: ["High Quality Pal Oil","Flame Organ"], food: 7, foodimage: foodImages, partnerSkill: "Stormbringer Lava Dragon", partnerSkillDescription: "Can be ridden. Enhances Fire attacks while mounted.", worksuitabilty: ["Kindling":4]),
            ...
            Pals(name: "Suzaku Aqua", icon: Image("Suzaku Aqua"), title: "Ruler of the Cobalt Dusk", number: "#102B", element: ["Water"], drops: ["Pal Fluids"], food: 8, foodimage: foodImages, partnerSkill: "Wings of Water", partnerSkillDescription: "Can be ridden as a flying mount. Enhances Water attacks while mounted.", worksuitabilty: ["Watering":3]),
            ...
            Pals(name: "Lyleen Noct", icon: Image("Lyleen_Noct"), title: "Empress of the Abyss", number: "#104B", element: ["Dark"], drops: ["Medical Supplies(L)","Beautiful Flower","Innovative Technical Manual"], food: 6, foodimage: foodImages, partnerSkill: "Goddess of the Tranquil Light", partnerSkillDescription: "When activated, the queen's soothing graces greatly restore the player's HP.", worksuitabilty: ["Handiwork":3,"Gathering":2,"Medicine Production":3]),
            ...
            Pals(name: "Frostallion Noct", icon: Image("Frostallion_Noct"), title: "Legendary Steed of Darkness", number: "#110B", element: ["Dark"], drops: ["Pure Quartz","Large Pal Soul"], food: 7, foodimage: foodImages, partnerSkill: "Black Steed", partnerSkillDescription: "Can be ridden as a flying mount. Changes the player's attack type to Dark and enhances Dark attacks while mounted.", worksuitabilty: ["Gathering":4]),
