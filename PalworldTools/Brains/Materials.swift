...
class MaterialsManager: ObservableObject{
    @Published var matslist: [materialsStruct] = [
        ...
        materialsStruct(name: "Large Pal Soul", icon: Image("Large_Paul_Soul_icon"), weight: 0.2, buyPrice: 0, sellPrice: 10, sources: ["Anubis", "Necromus", "Frostallion Noct", "Chests"]),
        materialsStruct(name: "Leather", icon: Image("Leather_icon"), weight: 0, buyPrice: 0, sellPrice: 0, sources: [""]),
        materialsStruct(name: "Lettuce Seeds", icon: Image("Lettuce_Seeds_icon"), weight: 0.15, buyPrice: 200, sellPrice: 20, sources: ["Wandering Merchants", "Bristla"]),
        ...
        materialsStruct(name: "Tomato Seeds", icon: Image("Tomato_Seeds_icon"), weight: 0, buyPrice: 100, sellPrice: 10, sources: ["Broncherry", "Dinossom Lux", "Mossanda", "Wandering Merchant"]),
        materialsStruct(name: "Venom Gland", icon: Image("Venom_Gland_icon"), weight: 0, buyPrice: 100, sellPrice: 10, sources: ["Pals", "Wandering Merchant"]),
        materialsStruct(name: "Wheat Seeds", icon: Image("Wheat_Seeds_icon"), weight: 0.05, buyPrice: 100, sellPrice: 10, sources: ["Wandering Merchant", "Dinossom", "Bristla", "Robinquill"]),
        materialsStruct(name: "Wood", icon: Image("Wood_icon"), weight: 3, buyPrice: 0, sellPrice: 1, sources: ["Tress", "Loot"]),
        materialsStruct(name: "Wool", icon: Image("Wool_icon"), weight: 1, buyPrice: 100, sellPrice: 10, sources: ["Pals", "Ranch", "Wandering Merchant"])
    ]
