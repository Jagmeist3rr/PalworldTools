...
class defenseBuildings: ObservableObject, BuildingManager{
    ...
    init(buildList: [buildingItems], materialsListManager: MaterialsListManager) {
        ...
        self.buildList = [
            ...
            buildingItems(name: "Mounted Missle Launcher", icon: Image("Mounted_Missile_Launcher"), tier: 50, points: 3, workload: 0, category: "Defenses", materialQuantities: ["Refined Ingot": 100, "Circuit Board": 20, "Nail": 20, "Cement": 50], materialsListManagers: ["Refined Ingot": MaterialsListManager(), "Circuit Board": MaterialsListManager(), "Nail": MaterialsListManager(), "Cement": MaterialsListManager()]),
